...
public class CourierDeliveryAndCollection {
    ...
    public static void main(String[] args) {
        CourierDeliveryAndCollection dac = new CourierDeliveryAndCollection();

        System.out.println("answer: " + dac.solution(4, 5, new int[]{1, 0, 3, 1, 2}, new int[]{0, 3, 0, 4, 0}));
        System.out.println("answer: " + dac.solution(2, 7, new int[]{1, 0, 2, 0, 1, 0, 2}, new int[]{0, 2, 0, 1, 0, 2, 0}));
    }
}
